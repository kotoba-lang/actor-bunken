...
(defn collection
  [name]
  (str "com.etzhayyim.bunken." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-bunken-coverage-get"
     :phase :event
  ...
  :bunken {:legacy-cell "com-etzhayyim-apps-bunken-bunken"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :bunkencollectionjob {:legacy-cell "com-etzhayyim-apps-bunken-bunkenCollectionJob"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "bunkencollectionjob")]
     :required-gates common-gates
     :trigger "manifest cell bunkencollectionjob"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
